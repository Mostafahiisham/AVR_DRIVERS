...
{
case UltraSonic_1 :
	DIO_SetPinLevel(US_PORT,US1_PIN,PIN_HIGH);
	_delay_us(10);
	DIO_SetPinLevel(US_PORT,US1_PIN,PIN_LOW);
	break;
case UltraSonic_2 :
	DIO_SetPinLevel(US_PORT,US2_PIN,PIN_HIGH);
	_delay_us(10);
	DIO_SetPinLevel(US_PORT,US2_PIN,PIN_LOW);
	break;
case UltraSonic_3 :
	DIO_SetPinLevel(US_PORT,US3_PIN,PIN_HIGH);
	_delay_us(10);
	DIO_SetPinLevel(US_PORT,US3_PIN,PIN_LOW);
	break;
case UltraSonic_4 :
	DIO_SetPinLevel(US_PORT,US4_PIN,PIN_HIGH);
	_delay_us(10);
	DIO_SetPinLevel(US_PORT,US4_PIN,PIN_LOW);
	break;
default :
	break;
}
